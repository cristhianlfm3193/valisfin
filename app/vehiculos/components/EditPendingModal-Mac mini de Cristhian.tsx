        ...
        <div className="px-6 py-5 border-b border-white/5 flex items-center justify-between bg-white/5/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Modifica los detalles del trabajo</p>
            </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto">
          <form ref={formRef} action={formAction} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-gray-300">Trabajo a realizar</label>
              <input 
                type="text" 
                name="service" 
                value={service}
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-gray-300">Observaciones</label>
              <textarea 
                name="notes"
                rows={3}
                value={notes}
