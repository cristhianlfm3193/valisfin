        ...
        <div className="p-6 overflow-y-auto">
          <form ref={formRef} action={formAction} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-slate-300">Vehículo</label>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 p-3 rounded-xl border text-sm font-semibold transition-all ${
                      selectedVehicle === v.id 
                        ...
                        : 'border-white/10 hover:border-slate-300 text-slate-400'
                    }`}
                  >
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-slate-300">¿Qué trabajo está pendiente?</label>
                ...
                {SUGGESTIONS.map(sug => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition-colors ${
                      service === sug ? 'bg-orange-500/20 border-orange-200 text-orange-400' : 'bg-white/5 border-white/10 text-slate-400 hover:bg-white/10'
                    }`}
                  >
                    {sug}
                  </button>
              ...
              <input 
                ...
                className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 focus:bg-[#121c27] focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all text-sm font-medium"
                required
              />
            </div>

            <div className="space-y-2">
              <label className="block text-sm font-semibold text-slate-300">Costo Estimado <span className="text-slate-400 font-normal">(Opcional)</span></label>
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="0.00"
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-white/10 bg-white/5 focus:bg-[#121c27] focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all font-mono text-lg font-bold"
                />
              </div>
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-slate-300">Observaciones <span className="text-slate-400 font-normal">(Opcional)</span></label>
              <textarea 
                name="notes"
                rows={2}
                placeholder="Agrega algún detalle o recomendación del mecánico..."
                className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 focus:bg-[#121c27] focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all text-sm resize-none"
              ></textarea>
            </div>
