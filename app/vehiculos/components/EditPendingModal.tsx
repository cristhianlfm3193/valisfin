...
export default function EditPendingModal({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm transition-opacity">
      {showSuccess && <LoadingCube text="Pendiente actualizado con éxito." theme="biz" />}
        ...
        <div className="p-6 overflow-y-auto">
          <form ref={formRef} action={formAction} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-slate-300">Trabajo a realizar</label>
              <input 
                type="text" 
                name="service" 
                value={service}
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-slate-300">Observaciones</label>
              <textarea 
                name="notes"
                rows={3}
                value={notes}
