      ...
      <div className="bg-[#181124] border border-white/10 rounded-3xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-gray-300">Nombre de la Sucursal</label>
            <input 
              required
              type="text"
              value={nombre}
              ...
              className="w-full bg-[#090a0f]/50/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm font-medium text-gray-100 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-bold text-gray-300">Latitud</label>
              <input 
                required
                type="number"
                step="any"
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-bold text-gray-300">Longitud</label>
              <input 
                required
                type="number"
                step="any"
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-gray-300">Dirección / Zona (Opcional)</label>
            <input 
              type="text"
              value={direccion}
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-gray-300">URL de Fotografía (Opcional)</label>
            <input 
              type="url"
              value={fotoUrl}
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-gray-300">Vendedor Asignado (Opcional)</label>
            <select 
              value={vendedorId}
          ...
          <div className="flex items-center gap-3 mt-2 bg-[#090a0f]/50/5 p-3 rounded-xl border border-white/10">
            <input 
              type="checkbox"
              id="cliente-activo"
              checked={activo}
