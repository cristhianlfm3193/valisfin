        ...
        <div className="flex flex-row items-center gap-3 w-full lg:w-auto">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-3 pr-2 py-2 rounded-xl bg-[#121c27] text-[#131b2e] text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all border border-white/10"
            ...
            {isFullScreen && (
              <div className="flex items-center justify-between mb-3 bg-[#121c27] p-3 rounded-2xl shadow-sm border border-white/10">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button onClick={handleToggleFullScreen} className="p-2 bg-slate-100 hover:bg-slate-200 text-slate-300 rounded-xl transition-colors">
          ...
          <div className="mt-4 px-2">
            ...
            <div className="flex justify-center gap-2 mt-4 text-[10px] font-bold flex-wrap">
              ...
              <button 
                ...
                className={`px-3 py-1 rounded-full border transition-all ${colFilterVendedor === 'sin_asignar' ? 'bg-slate-600 text-white border-slate-600 shadow-sm scale-105' : 'bg-white/5 text-slate-300 border-white/10 hover:bg-slate-100'}`}
              >
                No asignado
              </button>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 justify-between items-start lg:items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              <div className="flex flex-col flex-1 sm:flex-none">
                ...
                <select 
                  className="bg-white/5 border border-white/10 text-[#131b2e] text-sm rounded-xl px-4 py-2.5 focus:outline-none focus:border-indigo-500 focus:bg-[#121c27] transition-colors w-full sm:w-48 appearance-none"
                  value={rutaVendedor}
              ...
              <div className="flex flex-col flex-1 sm:flex-none">
                ...
                <input 
                  ...
                  className="bg-white/5 border border-white/10 text-[#131b2e] text-sm rounded-xl px-4 py-2.5 focus:outline-none focus:border-indigo-500 focus:bg-[#121c27] transition-colors w-full sm:w-40"
                />
              </div>
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  {selectedLocales.length > 0 && (
                    <button onClick={() => setSelectedLocales([])} className="text-[10px] bg-slate-100 hover:bg-slate-200 text-slate-400 px-2 py-1 rounded font-bold transition-colors">
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          {local.foto_url ? (
                            <img src={local.foto_url} alt={local.nombre_local} className="w-8 h-8 rounded-full object-cover shrink-0 bg-slate-100 border border-white/10" />
                          ) : (
                            <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center shrink-0 border border-white/10">
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="px-3 py-1.5 text-xs font-semibold bg-slate-100 text-slate-400 rounded-lg hover:bg-slate-200 disabled:opacity-50 transition-colors"
                  >
                    Anterior
                  </button>
                  <button 
