        ...
        <div className="bg-[#121c27] rounded-2xl p-4 shadow-sm border border-white/5 flex flex-col">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1 sm:gap-4 mb-3 px-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-[#131b2e] leading-tight">Vista interactiva de visitas <span className="text-indigo-400 font-black">({filteredLocales.length})</span></span>
            </div>
            ...
            {isFullScreen && (
              <div className="flex items-center justify-between mb-3 bg-[#121c27] p-3 rounded-2xl shadow-sm border border-white/10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#131b2e] hidden sm:inline">Vista interactiva de visitas <span className="text-indigo-400 font-black">({filteredLocales.length})</span></span>
                  <span className="font-bold text-[#131b2e] sm:hidden">Vista interactiva <span className="text-indigo-400 font-black">({filteredLocales.length})</span></span>
                </div>
          ...
          {rutaDistancia !== null && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-white/5 pt-5 mt-1">
              <div className="bg-white/5/80 border border-white/5 rounded-2xl p-4 flex flex-col justify-center items-center text-center">
                ...
                <span className="text-2xl font-black text-[#131b2e] flex items-baseline gap-1">{rutaDistancia.toFixed(1)} <span className="text-sm text-indigo-400 font-bold">km</span></span>
              </div>
              <div className="bg-white/5/80 border border-white/5 rounded-2xl p-4 flex flex-col justify-center items-center text-center">
              ...
              <div className="bg-white/5/80 border border-white/5 rounded-2xl p-4 flex flex-col justify-center items-center text-center">
                ...
                <span className="text-2xl font-black text-[#131b2e] flex items-baseline gap-1">{rutaVisitas.length > 0 ? (rutaDistancia / rutaVisitas.length).toFixed(1) : 0} <span className="text-sm text-emerald-400 font-bold">km/visita</span></span>
              </div>
            </div>
          )}
        </div>
