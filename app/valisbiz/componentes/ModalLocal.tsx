      ...
      <div className="bg-[#121c27] rounded-3xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-slate-400">Nombre de la Sucursal</label>
            <input 
              required
              type="text"
              value={nombre}
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm font-medium text-slate-200 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-bold text-slate-400">Latitud</label>
              <input 
                required
                type="number"
                step="any"
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-bold text-slate-400">Longitud</label>
              <input 
                required
                type="number"
                step="any"
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-slate-400">Dirección / Zona (Opcional)</label>
            <input 
              type="text"
              value={direccion}
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-slate-400">URL de Fotografía (Opcional)</label>
            <input 
              type="url"
              value={fotoUrl}
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-bold text-slate-400">Vendedor Asignado (Opcional)</label>
            <select 
              value={vendedorId}
