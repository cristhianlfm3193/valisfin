...
export async function crearLocal(data: { nombre_local: string; tipo: string; latitud: number; longitud: number; direccion: string | null; foto_url?: string | null; vendedor_id?: string | null; activo?: boolean; verificado?: boolean }) {
  const supabase = await createClient();
...
export async function editarLocal(id: string, data: { nombre_local: string; tipo: string; latitud: number; longitud: number; direccion: string | null; foto_url?: string | null; vendedor_id?: string | null; activo?: boolean; verificado?: boolean }) {
  const supabase = await createClient();
