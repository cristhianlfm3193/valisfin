        ...
        <div className="bg-[#121c27]/5 backdrop-blur-2xl rounded-3xl shadow-[0_20px_45px_-15px_rgba(0,0,0,0.5),0_0_1px_1px_rgba(255,255,255,0.1)] border border-white/10 overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[640px]">
          ...
          <section className="lg:col-span-5 relative flex flex-col justify-between overflow-hidden bg-[#090a0f] min-h-[380px] sm:min-h-[440px] lg:min-h-full p-6 sm:p-8 text-white order-1 lg:order-1">
            ...
            <article className="relative z-10 mt-auto pt-20">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-teal-500/30 backdrop-blur-md border border-teal-300/30 text-teal-100 text-xs font-semibold mb-3">
              ...
              <p className="mt-2 text-xs sm:text-sm text-teal-100/90 font-medium leading-relaxed">
                {settings?.welcomeSubtitle || "“Cada balboa cuidado es un paso firme y lleno de amor hacia su tranquilidad y mañana.”"}
              </p>
              
              <div className="mt-4 pt-3 border-t border-white/15 flex items-center justify-between text-[11px] text-teal-200/90">
          ...
          <section className="lg:col-span-7 flex flex-col justify-between p-6 sm:p-10 lg:p-12 order-2 lg:order-2 bg-[#090a0f]/40">
            <div>
              <div className="flex items-center justify-between pb-6 border-b border-white/10">
                {/* Logo */}
                <div className="flex items-center gap-3 relative z-10">
                  <div className="w-12 h-12 rounded-full p-[2px] bg-gradient-to-tr from-teal-400 via-emerald-400 to-pink-400 shadow-[0_0_20px_rgba(45,212,191,0.3)]">
                ...
                <div className="hidden sm:flex items-center gap-1.5 px-3 py-1 rounded-full bg-teal-500/20 border border-teal-500/30 text-[11px] font-semibold text-teal-300">
              ...
              <div className="mt-6 mb-6">
                ...
                <p className="mt-1 text-xs sm:text-sm text-gray-400 font-normal">
                  Inicia sesión y ve tu mundo de datos
                </p>
              </div>

              <div className="space-y-3">
                <p className="text-[11px] font-bold uppercase tracking-wider text-gray-500 flex items-center justify-between">
                  <span>Acceso</span>
                </p>
                <button
                  type="button"
              ...
              <div className="relative my-5">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-[#090a0f] px-3 text-[11px] font-semibold text-gray-500 uppercase tracking-wider">Alternativa</span>
                </div>
              </div>
                  ...
                  <form onSubmit={handlePasswordLogin} className="mt-3 p-4 bg-[#121c27]/5 backdrop-blur-md rounded-xl border border-white/10 space-y-3">
                    <div>
                      ...
                      <input 
                        ...
                        className="block w-full text-xs rounded-lg border-white/10 focus:border-teal-500 focus:ring-teal-500/20 py-2.5 px-3 border bg-black/20 text-white placeholder-gray-500" 
                        placeholder="admin@valisfin.com"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-gray-300 mb-1" htmlFor="admin-password">Contraseña</label>
                      <input 
                        type="password" 
                        id="admin-password" 
                        value={password}
                    ...
                    <button 
                      type="submit" 
                      className="w-full bg-teal-600 hover:bg-teal-500 text-white text-xs font-bold px-3 py-2.5 rounded-lg shrink-0 transition-colors mt-2"
                    >
                      Entrar como Admin
                    </button>
                  </form>
