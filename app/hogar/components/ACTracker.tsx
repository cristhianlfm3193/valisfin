    ...
    <>
      <section aria-label="Aires Acondicionados" className="px-4 sm:px-6 lg:px-8 py-2">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-sm font-bold text-slate-200 uppercase tracking-wider">Mantenimiento de Aires Acondicionados</h3>
        </div>
            ...
            return (
              <div key={unit.id} className="bg-[#121c27] rounded-2xl border border-white/10/80 p-5 shadow-sm relative group hover:border-blue-200 transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-4 mb-5">
                    ...
                    <div className="bg-white/5 p-2.5 rounded-xl border border-white/5">
                      ...
                      <p className={`font-semibold text-sm ${statusInfo.status === 'overdue' ? 'text-rose-600' : statusInfo.status === 'warning' ? 'text-amber-600' : 'text-slate-200'}`}>
                ...
                <button 
                  ...
                  className="w-full py-2.5 bg-[#121c27] border border-blue-200 text-blue-700 rounded-xl text-xs font-bold hover:bg-blue-50 transition-colors flex items-center justify-center gap-2"
                >
