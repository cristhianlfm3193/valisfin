...
export async function generateMonthlyIncomes(targetYear?: number, targetMonth?: number) {
  ...
  const expectedSalaries = [
    { profile_id: 'edc938dc-9fbc-4573-b007-0bdb95114f95', category: 'salario', period: 'q1', description: 'Salario Quincenal Cristhian', amount: 454.41, day: 12 },
    { profile_id: 'edc938dc-9fbc-4573-b007-0bdb95114f95', category: 'salario', period: 'q2', description: 'Salario Quincenal Cristhian', amount: 454.41, day: 27 },
    { profile_id: '7b5c62be-58f1-48d6-b366-0f504c39bdcb', category: 'salario', period: 'q1', description: 'Salario Quincenal Jennifer', amount: 428.86, day: 15 },
    { profile_id: '7b5c62be-58f1-48d6-b366-0f504c39bdcb', category: 'salario', period: 'q2', description: 'Salario Quincenal Jennifer', amount: 428.86, day: 30 },
    // Nuevos gastos solicitados
    { profile_id: '7b5c62be-58f1-48d6-b366-0f504c39bdcb', category: 'carro', period: 'q1', description: 'Gasto de Carro Jennifer', amount: 125.00, day: 9 },
    { profile_id: 'edc938dc-9fbc-4573-b007-0bdb95114f95', category: 'representacion', period: 'q1', description: 'Gastos de Representación', amount: 140.43, day: 12 },
    { profile_id: 'edc938dc-9fbc-4573-b007-0bdb95114f95', category: 'representacion', period: 'q2', description: 'Gastos de Representación', amount: 140.43, day: 27 },
  ];
  ...
  const missingSalaries = expectedSalaries.filter(expected => {
    ...
    const exists = existingIncomes?.some(
      inc => inc.profile_id === expected.profile_id && inc.period === expected.period && inc.description === expected.description
    );
    return !exists;
  });
