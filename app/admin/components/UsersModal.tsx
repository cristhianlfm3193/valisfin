  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-[#121c27] rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-white/10 transform transition-all flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar flex-1 bg-[#121c27]">
          ...
          <div className="space-y-3">
            {users.map((user) => {
              ...
              return (
                <div key={user.id} className="flex items-center justify-between p-4 rounded-2xl border border-white/5 bg-white/5/50 hover:bg-white/5 transition-colors">
                  ...
                  <div className="flex items-center gap-4 pl-4">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                      isAdmin 
                        ...
                        : 'bg-slate-100 text-slate-400 border border-white/10'
                    }`}>
                      {user.role}
                    </span>
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        >
                          ...
                          <span
                            aria-hidden="true"
                            className={`pointer-events-none absolute left-0 inline-block h-5 w-5 transform rounded-full bg-[#121c27] shadow ring-0 transition duration-200 ease-in-out flex items-center justify-center ${
        ...
        {/* Footer */}
        <div className="p-4 sm:p-6 border-t border-white/5 bg-white/5/50 flex justify-end">
          <button
            onClick={onClose}
