  ...
  const modalContent = (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 sm:inset-0 sm:flex sm:items-center sm:justify-center z-[110] pointer-events-none p-4">
        <div 
          className="max-h-[90vh] overflow-y-auto custom-scrollbar bg-[#121c27] border-white/10 rounded-t-3xl sm:rounded-3xl w-full max-w-sm shadow-2xl pointer-events-auto flex flex-col overflow-hidden"
        ...
        >
          <div className="flex items-center justify-between p-5 border-b border-white/5 shrink-0 bg-white/5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-white leading-tight">Detalles del Evento</h3>
          ...
          <div className="p-6 space-y-5">
            <div>
              <h4 className="text-xl font-extrabold text-white">{event.title}</h4>
              <p className="text-sm font-medium text-gray-400 mt-1 capitalize">{formatDate(event.date)}</p>
            </div>
            ...
            <div className="space-y-3">
              {event.amount !== undefined && event.amount !== null && (
                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-white">{formatCurrency(event.amount)}</p>
                  </div>
                </div>
              )}
              ...
              <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/5">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-white">{event.category}</p>
                </div>
              </div>
              ...
              {event.time && (
                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-white">{event.time.substring(0, 5)}</p>
                  </div>
                </div>
              )}
            </div>
