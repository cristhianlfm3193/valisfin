  ...
  const modalContent = (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 sm:inset-0 sm:flex sm:items-center sm:justify-center z-[110] pointer-events-none p-4">
        <div 
          className="max-h-[90vh] overflow-y-auto custom-scrollbar bg-[#121c27] rounded-t-3xl sm:rounded-3xl w-full max-w-sm shadow-2xl pointer-events-auto flex flex-col overflow-hidden"
            ...
            <div className="space-y-3">
              {event.amount !== undefined && event.amount !== null && (
                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/5">
                  <div className="bg-[#121c27] p-2 rounded-lg shadow-sm">
