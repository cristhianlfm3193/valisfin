        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <label 
                  className={`cursor-pointer relative flex items-center gap-3 p-3 rounded-2xl transition-all ${
                    person === 'cristhian' 
                      ...
                      : 'border border-white/10 bg-[#121c27] hover:border-slate-300 hover:bg-white/5/60'
                  }`}
                >
                  <input 
                    type="radio" 
                  ...
                  <div className={`w-9 h-9 rounded-xl font-bold flex items-center justify-center text-xs shrink-0 shadow-sm ${
                    person === 'cristhian' ? 'bg-emerald-700 text-white' : 'bg-slate-100 text-slate-500 border border-white/10'
                  }`}>
                    CF
                  </div>
                  <div className="min-w-0">
                    <div className={`text-sm leading-tight ${person === 'cristhian' ? 'font-bold text-white' : 'font-semibold text-slate-300'}`}>Cristhian Fuentes</div>
                  </div>
                ...
                >
                  ...
                  />
                  <div className={`w-9 h-9 rounded-xl font-bold flex items-center justify-center text-xs shrink-0 shadow-sm ${
                    person === 'jennifer' ? 'bg-emerald-700 text-white' : 'bg-slate-100 text-slate-500 border border-white/10'
                  }`}>
                    JC
                  </div>
                  <div className="min-w-0">
                    <div className={`text-sm leading-tight ${person === 'jennifer' ? 'font-bold text-white' : 'font-semibold text-slate-300'}`}>Jennifer Camaño</div>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Categoría / Tipo */}
              <div>
                <label htmlFor="income-category" className="block text-xs font-bold uppercase tracking-wider text-slate-400 mb-1.5">
              ...
              {/* Período / Quincena */}
              <div>
                <label htmlFor="income-period" className="block text-xs font-bold uppercase tracking-wider text-slate-400 mb-1.5">
                  Período Asignado <span className="text-emerald-600">*</span>
                </label>
                <select id="income-period" name="income-period" className="w-full px-3.5 py-2.5 bg-white/5 border border-white/10 rounded-xl text-sm font-medium text-slate-200 focus:bg-[#121c27] focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all">
            ...
            <div>
              <label htmlFor="income-title" className="block text-xs font-bold uppercase tracking-wider text-slate-400 mb-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Monto */}
              <div>
                <label htmlFor="income-amount" className="block text-xs font-bold uppercase tracking-wider text-slate-400 mb-1.5">
              ...
              {/* Fecha Prevista */}
              <div>
                <label htmlFor="income-date" className="block text-xs font-bold uppercase tracking-wider text-slate-400 mb-1.5">
