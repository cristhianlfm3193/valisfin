...
export default function ConsultasClient({ initialTransactions }: ConsultasClientProps) {
  ...
  const getModuleStyle = (mod: string) => {
    switch (mod) {
      ...
      default: return { bg: 'bg-white/10', text: 'text-slate-300', icon: Filter };
    }
  };
            ...
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold transition-all shadow-sm ${
                activeModule === mod 
                  ...
                  : 'bg-white/10 text-slate-400 hover:bg-slate-200 border border-white/10'
              }`}
            >
              <span>{mod}</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 pt-3">
          ...
          <div className="flex items-end">
            <button 
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white/10 hover:bg-slate-200 text-slate-300 text-sm font-bold transition-colors border border-white/10"
            >
      ...
      <div className="flex flex-col bg-[#121c27] rounded-2xl shadow-sm border border-white/10/80 overflow-hidden">
        ...
        <div className="p-5 flex items-center justify-between flex-wrap gap-3 border-b border-white/5">
          <div className="flex items-center gap-2">
            ...
            <span className="px-2.5 py-0.5 rounded-full bg-white/10 text-xs text-slate-500 font-bold border border-white/10">
