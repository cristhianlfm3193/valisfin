  ...
  return (
    <>
        ...
        <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-9 pr-3 py-2 bg-[#121c27] border-white/10 border border-white/10 rounded-full text-sm font-medium text-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all cursor-pointer shadow-[0_4px_12px_rgba(0,0,0,0.5)] hover:bg-white/5"
            />
          </div>
          <button className="sm:hidden flex items-center justify-center gap-1.5 px-3.5 py-2.5 rounded-full bg-white/10 text-gray-300 font-semibold text-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4 lg:gap-6 mb-6">
        ...
        {/* Supermercado */}
        <div className="bg-[#121c27] border-white/10 rounded-3xl p-5 sm:p-6 shadow-[0_4px_12px_rgba(0,0,0,0.5)] flex flex-col justify-between group hover:shadow-[0_8px_24px_rgba(0,0,0,0.6)] transition-shadow border border-white/5">
          <div className="flex flex-wrap sm:flex-nowrap items-start justify-between gap-2 mb-4">
            <div className="flex items-center gap-2 lg:gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] lg:text-xs text-gray-400 truncate">Presupuesto mensual</p>
              </div>
            </div>
            <span className="shrink-0 inline-flex items-center px-2 py-0.5 lg:px-2.5 lg:py-1 rounded-full text-[10px] lg:text-xs font-semibold bg-white/10 text-gray-300">
          ...
          <div className="space-y-3 mt-1">
            <div className="flex flex-wrap items-baseline gap-1 lg:gap-2">
              ...
              <span className="text-[10px] lg:text-xs xl:text-sm font-medium text-gray-400 font-mono">de B/. {budgets.Supermercado.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 pt-1">
              <span className="text-[10px] lg:text-xs text-gray-400">No utilizado:</span>
        ...
        <div className="bg-[#121c27] border-white/10 rounded-3xl p-5 sm:p-6 shadow-[0_4px_12px_rgba(0,0,0,0.5)] flex flex-col justify-between group hover:shadow-[0_8px_24px_rgba(0,0,0,0.6)] transition-shadow border border-white/5">
          <div className="flex flex-wrap sm:flex-nowrap items-start justify-between gap-2 mb-4">
            <div className="flex items-center gap-2 lg:gap-3 min-w-0">
              <div className="w-8 h-8 lg:w-10 lg:h-10 shrink-0 rounded-2xl bg-white/10 text-gray-300 flex items-center justify-center">
          ...
          <div className="space-y-3 mt-1">
            <div className="flex flex-wrap items-baseline gap-1 lg:gap-2">
              ...
              <span className="text-[10px] lg:text-xs xl:text-sm font-medium text-gray-400 font-mono">de B/. {budgets.Gasolina.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
            </div>
            <div className="w-full bg-white/10 rounded-full h-2 lg:h-2.5 overflow-hidden flex">
              <div 
                className="bg-emerald-600 h-full rounded-full transition-all duration-500" 
        ...
        <div className="bg-[#121c27] border-white/10 rounded-3xl p-5 sm:p-6 shadow-[0_4px_12px_rgba(0,0,0,0.5)] flex flex-col justify-between group hover:shadow-[0_8px_24px_rgba(0,0,0,0.6)] transition-shadow border border-white/5">
          ...
          <div className="space-y-3 mt-1">
            <div className="flex flex-wrap items-baseline gap-1 lg:gap-2">
              ...
              <span className="text-[10px] lg:text-xs xl:text-sm font-medium text-gray-400 font-mono">de B/. {budgets.Ocio.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
            </div>
            <div className="w-full bg-white/10 rounded-full h-2 lg:h-2.5 overflow-hidden flex">
              <div 
        ...
        <div className="bg-[#121c27] border-white/10 rounded-3xl p-5 sm:p-6 shadow-[0_4px_12px_rgba(0,0,0,0.5)] flex flex-col justify-between group hover:shadow-[0_8px_24px_rgba(0,0,0,0.6)] transition-shadow border border-white/5">
          ...
          <div className="space-y-3 mt-1">
            <div className="flex flex-wrap items-baseline gap-1 lg:gap-2">
              ...
              <span className="text-[10px] lg:text-xs xl:text-sm font-medium text-gray-400 font-mono">de B/. {budgets.Restaurante.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
            </div>
            <div className="w-full bg-white/10 rounded-full h-2 lg:h-2.5 overflow-hidden flex">
              <div 
      ...
      {/* Filter Cockpit */}
      <div className="bg-[#121c27] border-white/10 rounded-3xl p-4 sm:p-5 shadow-[0_4px_12px_rgba(0,0,0,0.5)] space-y-4 mb-6 border border-white/5">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 w-full">
          <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0 scrollbar-none w-full min-w-0">
            <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold mr-1">Pagador:</span>
            <button 
              onClick={() => setPersonFilter('all')}
              className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all whitespace-nowrap ${personFilter === 'all' ? 'bg-slate-900 text-white' : 'bg-white/10 text-gray-300 hover:bg-slate-200'}`}
            >
              Todos ({expenses.length})
            </button>
            <button 
              onClick={() => setPersonFilter('cristhian')}
              className={`px-3 py-1.5 rounded-full text-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap ${personFilter === 'cristhian' ? 'bg-slate-900 text-white' : 'bg-white/10 text-gray-300 hover:bg-slate-200'}`}
            >
            ...
            <button 
              ...
              className={`px-3 py-1.5 rounded-full text-sm font-medium transition-all flex items-center gap-2 whitespace-nowrap ${personFilter === 'jennifer' ? 'bg-pink-500 text-white' : 'bg-white/10 text-gray-300 hover:bg-slate-200'}`}
            >
              <span className={`w-5 h-5 rounded-full text-[10px] font-bold flex items-center justify-center ${personFilter === 'jennifer' ? 'bg-[#121c27] border-white/10 text-pink-600' : 'bg-pink-500 text-white'}`}>JC</span>
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 pt-1 text-nowrap scrollbar-none w-full min-w-0">
          <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold mr-1 shrink-0">Categoría:</span>
          {['all', 'Alimentación', 'Supermercado', 'Restaurante', 'Ocio', 'Tecnología', 'Gasolina', 'Transporte', 'Salud', 'Gastos Valeria (Hija)', 'Recargas / Telefonía', 'Otros'].map(cat => (
            <button
              ...
              className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${categoryFilter === cat ? 'bg-emerald-100 text-emerald-700 font-semibold' : 'bg-white/5 text-gray-300 hover:bg-white/10 border border-white/10'}`}
            >
              {cat === 'all' ? 'Todas' : cat}
            </button>
          ))}
      ...
      {/* Data Section */}
      <div className="bg-[#121c27] border-white/10 rounded-3xl p-5 sm:p-7 shadow-[0_4px_12px_rgba(0,0,0,0.5)] space-y-4 border border-white/5 w-full min-w-0 overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <h2 className="text-xl font-bold text-white">Gastos recientes</h2>
            <p className="text-sm text-gray-400">Los egresos se muestran con signo negativo y reflejo contable inmediato.</p>
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <span className="text-sm text-gray-400">Total filtrado:</span>
        ...
        <div className="overflow-x-auto w-full">
          <table className="w-full text-left">
            <thead>
              <tr className="text-gray-400 uppercase text-xs font-semibold tracking-wider border-b border-white/5">
              ...
              {filteredExpenses.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE).map((expense) => {
                ...
                return (
                  <tr key={expense.id} className="hover:bg-white/5 transition-colors border-b border-slate-50 last:border-0">
                    <td className="py-4 px-3 text-gray-400 font-mono">{formattedDate}</td>
                    <td className="py-4 px-3">
                      <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-white/10 text-gray-300">
                        {expense.category}{expense.sub_category ? ` - ${expense.sub_category}` : ''}
                      </span>
                    </td>
                    <td className="py-4 px-3 font-medium text-white max-w-xs truncate">{expense.detail}</td>
                    <td className="py-4 px-3">
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg border border-white/10 bg-[#121c27] border-white/10 shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
                        ...
                        <span className="text-xs font-medium text-gray-300">{expense.profiles?.first_name || 'Desconocido'}</span>
                      </span>
                    </td>
          ...
          <div className="flex items-center justify-between border-t border-white/5 pt-4 mt-2">
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="p-1 rounded-lg text-gray-400 hover:bg-white/10 disabled:opacity-50 disabled:hover:bg-transparent transition-colors"
              >
