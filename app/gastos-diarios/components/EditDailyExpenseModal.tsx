        ...
        >
          <div className="flex items-center justify-between p-5 border-b border-white/5 shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Modificar registro existente</p>
              </div>
            </div>
            <button 
              onClick={onClose}
            ...
            <form id="edit-daily-expense-form" onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2">
                <label className="flex items-center gap-3 p-3 rounded-xl border border-white/10 bg-white/5 cursor-pointer hover:bg-slate-100 transition-colors">
                  ...
                  <div>
                    <span className="text-sm font-bold text-slate-200">Uso tarjeta de crédito</span>
          ...
          <div className="p-5 pt-3 border-t border-white/5 flex items-center justify-end gap-3 bg-white/5 shrink-0">
            ...
            <button
              ...
              disabled={isLoading}
              className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-xl text-sm font-semibold shadow-sm transition-all disabled:opacity-70"
            >
              {isLoading ? (
