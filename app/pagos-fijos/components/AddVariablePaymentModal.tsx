  ...
  const modalContent = (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 sm:inset-0 sm:flex sm:items-center sm:justify-center z-[110] pointer-events-none p-4">
        <div 
          className="bg-[#121c27] border-white/10 rounded-t-3xl sm:rounded-3xl w-full max-w-lg shadow-2xl pointer-events-auto transform transition-all flex flex-col max-h-[90vh]"
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 pb-4 border-b border-white/5">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Electricidad, Gasolina, Supermercado...</p>
              </div>
            </div>
            <button 
              onClick={() => setIsOpen(false)}
          ...
          <div className="p-6 pt-4 border-t border-white/5 flex items-center justify-end gap-3 bg-white/5 rounded-b-3xl">
            <button
              type="button"
              onClick={() => setIsOpen(false)}
              className="px-5 py-2.5 rounded-xl text-sm font-semibold text-gray-300 hover:bg-slate-200 transition-colors"
            >
              Cancelar
            </button>
            <button
              ...
              disabled={isLoading}
              className="inline-flex items-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white px-6 py-2.5 rounded-xl text-sm font-semibold shadow-[0_4px_12px_rgba(0,0,0,0.5)] transition-all disabled:opacity-70"
            >
              {isLoading ? (
  ...
  return (
    <>
      <button 
        ...
        className="inline-flex items-center gap-2 bg-emerald-700 text-white hover:bg-emerald-800 px-4 py-2 rounded-full text-sm font-semibold shadow-[0_4px_12px_rgba(0,0,0,0.5)] transition hover:shadow-[0_8px_24px_rgba(0,0,0,0.6)] active:scale-95"
      >
