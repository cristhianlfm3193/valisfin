  ...
  const modalContent = (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 sm:inset-0 sm:flex sm:items-center sm:justify-center z-[110] pointer-events-none p-4">
        <div 
          className="max-h-[90vh] overflow-y-auto custom-scrollbar bg-[#121c27] rounded-t-3xl sm:rounded-3xl w-full max-w-sm shadow-2xl pointer-events-auto transform transition-all flex flex-col"
            ...
            <form id="partial-payment-form" onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-2">
                  Saldo total pendiente: <span className="font-semibold text-slate-300">B/. {maxAmount.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</span>
                </p>
              </div>
            </form>
          </div>
