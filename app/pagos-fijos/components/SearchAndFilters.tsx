    ...
    <section className="mb-5 space-y-3">
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            type="text"
            className="w-full pl-10 pr-4 py-2.5 bg-[#121c27] border border-white/10 rounded-xl text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-shadow"
