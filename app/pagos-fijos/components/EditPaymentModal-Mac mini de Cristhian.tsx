  ...
  const modalContent = (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 sm:inset-0 sm:flex sm:items-center sm:justify-center z-[110] pointer-events-none p-4">
        <div 
          className="max-h-[90vh] overflow-y-auto custom-scrollbar bg-[#121c27] border-white/10 rounded-t-3xl sm:rounded-3xl w-full max-w-sm shadow-2xl pointer-events-auto flex flex-col"
          ...
          <div className="p-5">
            <form id="edit-payment-form" onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[10px] text-gray-400">Dejar en blanco si no aplica o es variable.</p>
              </div>
          ...
          <div className="p-5 pt-3 border-t border-white/5 flex items-center justify-between gap-3 bg-white/5 rounded-b-3xl shrink-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-slate-900 hover:bg-black text-white px-5 py-2 rounded-xl text-sm font-semibold shadow-[0_4px_12px_rgba(0,0,0,0.5)] transition-all disabled:opacity-70"
              >
                {isLoading ? (
